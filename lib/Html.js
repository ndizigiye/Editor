...
Html.prototype.addButton = function(name,type,data) {
	var html = '<button id="'+name+'" onclick="emitter(\''+type+'\',\''+data+'\')">'+name+'</button>';
	var delButton = '<button class="delete" onclick="$(this).prev().remove();$(this).remove();location.reload();">Delete</button><br>';
