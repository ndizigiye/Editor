...
Html.prototype.addPresentationButton = function(name,data) {
	var parentDiv  = ["<div data-role='controlgroup' data-type='horizontal'>","</div>"];
	var html =  '<a href="#" data-role="button" data-iconpos="notext" data-icon="plus" data-theme="b">Add</a>'+'\n'
    			'<a href="#" data-role="button">'+name+'</a>'+'\n'
